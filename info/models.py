...
time_slots = (
    ...
    ('12:20 - 01:10', '12:20 - 01:10'),
    ('01:10 - 02:00', '01:10 - 02:00'),
    ('02:00 - 02:50', '02:00 - 02:50'),
)
...
test_name = (
    ...
    ('Internal practical', 'Internal practical'),
)
...
class AssignTime(models.Model):
    ...
    period = models.CharField(max_length=50, choices=time_slots, default='9:00 - 9:50')
...
class Assignment(models.Model):
    teacher = models.ForeignKey(Teacher, on_delete=models.CASCADE)
    title = models.CharField(max_length=255, unique=True)  # Ensuring title is unique
        ...
        if hasattr(instance, 'name'):
            ...
            for ass in ass_list:
                try:
                    ...
                    sc.save()
                    sc.marks_set.create(name='Internal exam')
                    sc.marks_set.create(name='Internal practical')
